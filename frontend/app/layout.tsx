...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "CNC Machining",
    "CAD CAM Training in Pune",
    "Sanaswadi CNC Institute",
    "Best CNC Institute in Pune",
    "Best CNC institute in Sanaswadi",
    "Finix cnc institute",
    "best cnc institute in pune with placements",
    "CAD CAM Training in Sanaswadi",
    "CNC Training near Wagholi",
    "CNC VMC HMC Training near Shikrapur",
